...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.groupBox.setGeometry(QtCore.QRect(240, 460, 411, 83))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(240, 560, 411, 111))
        ...
        self.connectLabel.setGeometry(QtCore.QRect(680, 460, 101, 111))
        ...
        self.gBoxSerialNumber = QtWidgets.QGroupBox(self.grBox_SettingsMode)
        self.gBoxSerialNumber.setGeometry(QtCore.QRect(280, 150, 331, 141))
        self.gBoxSerialNumber.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.gBoxSerialNumber.setObjectName("gBoxSerialNumber")
        self.lineEdit_SN = QtWidgets.QLineEdit(self.gBoxSerialNumber)
        self.lineEdit_SN.setGeometry(QtCore.QRect(80, 40, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.lineEdit_SN.setFont(font)
        self.lineEdit_SN.setMaxLength(16)
        self.lineEdit_SN.setObjectName("lineEdit_SN")
        self.pButtonWriteSN = QtWidgets.QPushButton(self.gBoxSerialNumber)
        self.pButtonWriteSN.setGeometry(QtCore.QRect(20, 80, 141, 41))
        self.pButtonWriteSN.setObjectName("pButtonWriteSN")
        self.pButtonReadSN = QtWidgets.QPushButton(self.gBoxSerialNumber)
        self.pButtonReadSN.setGeometry(QtCore.QRect(170, 80, 141, 41))
        self.pButtonReadSN.setObjectName("pButtonReadSN")
    ...
    def retranslateUi(self, Settings):
        ...
        self.gBoxSerialNumber.setTitle(_translate("Settings", "Serial Number"))
        self.lineEdit_SN.setText(_translate("Settings", "LL01-00000000000"))
        self.pButtonWriteSN.setText(_translate("Settings", "Write"))
        self.pButtonReadSN.setText(_translate("Settings", "Read"))
